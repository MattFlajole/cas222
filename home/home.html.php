...
<main>
    <section class="top">
        <div class="photo">
            <img class="img-home" src="images/ace17.jpg" alt="Ace in the Hole Multisport Events">
        </div>
        <h2>Heading 2</h2>
        <p>Ace in the Hole Multisport Events is  hosting multisport athletic events on March 27th and 28th, 2021. Ace in the Hole Multisport Events is proud to offer running and triathlon events to athletes of all shapes and sizes, national origins, gender identifications and cultural backgrounds. We offer Events for Every Body.
    </section>
    <aside class="sidebar">
