    ...
    <body>
        <div id="wrapper">
            ...
            <main>
                <section class="top">
                    <div class="photo">
                        <img class="img-home" src="../images/ace10.jpg" alt="Ace in the Hole Multisport Events">
                    </div>
                    <h2>ABOUT The Event</h2>
                    <p>The Annual Ace in the Hole Multisport Weekend is a legendary event in the Oregon triathlon and running community. It has become a traditional destination race for athletes from across the nation. <br>There is something for every level of athletic ability. The weekend includes a first timer triathlon, a sprint, Olympic, and Half-Iron triathlons and 10K and Half marathon runs. Come to experience your first race or come to compete to win, but make sure you come to have fun!</p>


<!--                    <p>Ace in the Hole Multisport Events is an company that runs a two-day multisport event that has triathlons and running events of varying distances. The client's Ace in the Hole Multisport Events company supports multiple aspects of diversity in their events and is proud to offer running and triathlon events to athletes of all shapes and sizes, national origins, gender identifications and cultural backgrounds. We offer Events for Every Body. Events will held on March 27th and 28th, 2020.</p>
-->                </section>
                <aside class="sidebar">
